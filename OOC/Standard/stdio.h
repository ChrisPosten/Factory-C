 ...
 *                                                                             *
 * this file was modified: (12/27/2021) finished: (02/12/2023) (see printf)    *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
typedef struct _iobuf
{
	...
	int	            _bufsiz;
	char *	        _tmpfname;
} FILE ;/**File primary OOC class name for new(Class) (02/18/2022)*/
...
#if !__USE_MINGW_ANSI_STDIO /// !__USE_MINGW_ANSI_STDIO
/*
...
/** * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * **
 * @brief the printf family modified for Factory C               *
 *                                                               *
 * now that the right case has been added to printf, we can consider
 *                                                               *
 * that all that needs to be done from this point for housekeeping,
 *                                                               *
 * is that the scanf family of functions should be dug up and given
 *                                                               *
 * the same case. that way scanf and printf will be used from the*
 *                                                               *
 * object-oriented cin/cout. it (printf) is currently used from cout.
 *                                                               *
 * I should note that when encapsulating a case of a converter   *
 *                                                               *
 * being used for an object-oriented implementation, use printf  *
 *                                                               *
 * not cout (use cout where the object is, not inside its class  *
 *                                                               *
 * methods at least the class(ConsoleTable) or IO family of tables).
 *                                                               *
 ** * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * **/
...
/// /// /// /// /// /// /// /// /// /// /// /// /// /// /// /// ///
  ...
  if( default(0) ){ /*puts("format:");puts( ((void****)ControlSlot)[0][0][0] );*/ } //default(0) ? ((void****)ControlSlot)[0][0][0] :

  register int __retval;//default(0) ? ((void****)ControlSlot)[0][0][0] :
  __builtin_va_list __local_argv;   /// /// /// /// /// /// /// /// /// /// /// /// ///
  __builtin_va_start( __local_argv, /*default(0) ? ((void****)ControlSlot)[0][0][0] : */ __format );/// /// ///

  if( default(0) ){__local_argv = &((void****)ControlSlot)[0][0][1] ;}

  __retval = __mingw_vprintf( default(0) ? ((void****)ControlSlot)[0][0][0] : __format, __local_argv );///
...
/// /// /// /// /// /// /// /// /// /// /// /// /// /// /// /// ///
  ...
  __retval = __mingw_vfprintf( __stream, default(0) ? ((void****)ControlSlot)[0][0][0] : __format, __local_argv );///
  __builtin_va_end( __local_argv ); /// /// /// /// /// /// /// /// /// /// /// /// /// ///
  return __retval;
}
#define __standard_helper(__retval) StandardHelper( ConsoleOut(Object), __retval )
/// /// /// /// /// /// /// /// /// /// /// /// /// /// /// /// ///
__mingw_stdio_redirect__
...
/// /// /// /// /// /// /// /// /// /// /// /// /// /// /// /// ///
  ...
  if( default(24) )
  {
    ...
    void* p = __standard_helper(__retval);

    if(p){ __stream = p; }
  }

  __retval = __mingw_vsprintf( __stream, default(0) ? ((void****)ControlSlot)[0][0][0] : __format, __local_argv );///
  __builtin_va_end( __local_argv ); /// /// /// /// /// /// /// /// /// /// /// /// /// ///
  return __retval;
}
/// /// /// /// /// /// /// /// /// /// /// /// /// /// /// /// ///
